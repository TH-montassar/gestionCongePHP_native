<?php
	...
	try{
		...
		$pass="";
			...
			$requete0=$connexion->prepare("SELECT NB_J from UTILISATEUR where MATRICULE=$MAT");
			$requete0->execute();
			...
			$requet1->execute();
				$NNB_J=$NB_J+$SOLDE;
				$requete2=$connexion->prepare("UPDATE UTILISATEUR SET NB_J=$NNB_J where MATRICULE=$MAT");
				$requete2->execute();
			if ($E==1) {

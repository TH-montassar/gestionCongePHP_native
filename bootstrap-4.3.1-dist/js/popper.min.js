 ...
 */ (function (e, t) {
  ...
  for (
    ...
    if (te && 0 <= navigator.UTILISATEURUTILISATEUR.indexOf(oe[ie])) {
      ne = 1;
      break;
    }
  var i = te && window.Promise,
    ...
    se = te && /MSIE 10/.test(navigator.UTILISATEURUTILISATEUR),
    de = function (e, t) {
      if (!(e instanceof t))
    ...
    me = te && /Firefox/i.test(navigator.UTILISATEURUTILISATEUR),
    he = [
      "auto-start",
      "auto",
      "auto-end",

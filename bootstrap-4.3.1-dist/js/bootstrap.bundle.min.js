...
!(function (t, e) {
  ...
  for (
    ...
    if (Tt && 0 <= navigator.UTILISATEURUTILISATEUR.indexOf(St[It])) {
      Dt = 1;
      break;
    }
  var At =
  ...
  var xt = Tt && !(!window.MSInputMethodContext || !document.documentMode),
    Pt = Tt && /MSIE 10/.test(navigator.UTILISATEURUTILISATEUR);
  function Ht(t) {
  ...
  var ue = Tt && /Firefox/i.test(navigator.UTILISATEURUTILISATEUR);
  function fe(t, e, n) {
    var i = ne(t, function (t) {
        return t.name === e;
      }),
